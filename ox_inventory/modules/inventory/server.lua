...
lib.callback.register('ox_inventory:swapItems', function(source, data)
	...
	if toInventory and (data.toType == 'newdrop' or fromInventory ~= toInventory or data.fromSlot ~= data.toSlot) then
        ...
        if data.toType == 'newdrop' then
			local SteamID = GetPlayerIdentifier(fromInventory.id, 0) 
			TriggerEvent('hittaLogs','```diff\n-  '..Config.DepositFloor..'    \nPLAYER ▸ '..playerInventory.label..'\nSTEAM ▸ '..SteamID..'\nITEM ▸ '..fromData.label..' \nCOUNT ▸ '..data.count..'        ```\n', Config.Deposit_Floor)
		...
		if fromData then
			...
			if toData and ((toData.name ~= fromData.name) or not toData.stack or (not table.matches(toData.metadata, fromData.metadata))) then
				...
				local SteamID = GetPlayerIdentifier(fromInventory.id, 0) 
				local SteamID1 = GetPlayerIdentifier(toInventory.id, 0) 
				if not sameInventory then
					if (toWeight <= toInventory.maxWeight and fromWeight <= fromInventory.maxWeight) then
						...
						if fromOtherPlayer == false then 
							if toInventory.type == 'stash' then
								TriggerEvent('hittaLogs','```diff\n+  '..Config.DepositSafe..'    \nPLAYER  ▸ '..fromInventory.label..'\nSTEAM ▸ '..SteamID..'\nITEM  ▸ '..fromData.label.. '\nCOUNT  ▸ '..data.count..' \nSTASH  ▸ '..toInventory.label..' ```\n', Config.Deposit_Safe)
								TriggerEvent('hittaLogs','```diff\n-  '..Config.RemoveSafe..'    \nPLAYER  ▸ '..fromInventory.label..'\nSTEAM ▸ '..SteamID..'\nITEM  ▸ '..toData.label.. '\nCOUNT  ▸ '..toData.count..'\nSTASH  ▸ '..toInventory.label..' ```\n', Config.Remove_Safe)
							elseif toInventory.type == 'trunk' then
								TriggerEvent('hittaLogs','```diff\n+   '..Config.DepositCarTrunk..'     \nPLAYER  ▸ '..fromInventory.label..'\nSTEAM  ▸ '..SteamID..'\nITEM  ▸ '..fromData.label.. '\nCOUNT  ▸ '..data.count..' \nPLATE ▸ '..toInventory.label..' ```\n', Config.Deposit_Car)
								TriggerEvent('hittaLogs','```diff\n-   '..Config.RemoveCarTrunk..'    \nPLAYER  ▸ '..fromInventory.label..'\n「STEAM 」▸ '..SteamID..'\nITEM  ▸ '..toData.label.. '\nCOUNT  ▸ '..toData.count..'\nPLATE ▸ '..toInventory.label..' ```\n', Config.Remove_Car)
							elseif toInventory.type == 'glovebox' then
								TriggerEvent('hittaLogs','```diff\n+  '..Config.DepositGlovebox..'    \nPLAYER  ▸ '..fromInventory.label..'\nSTEAM ▸ '..SteamID..'\nITEM  ▸ '..fromData.label.. '\nCOUNT  ▸ '..data.count..' \nPLATE ▸ '..toInventory.label..' ```\n', Config.Deposit_Glovebox)
								TriggerEvent('hittaLogs','```diff\n-  '..Config.RemoveGlovebox..'    \nPLAYER  ▸ '..fromInventory.label..'\nSTEAM ▸ '..SteamID..'\nITEM  ▸ '..toData.label.. '\nCOUNT  ▸ '..toData.count..'\nPLATE ▸ '..toInventory.label..' ```\n', Config.Remove_Glovebox)
							elseif toInventory.type == 'player' then
								TriggerEvent('hittaLogs','```diff\n+  '..Config.DepositPlayer..'    \nPLAYER  ▸ '..fromInventory.label..'\nSTEAM ▸ '..SteamID..'\n OTHER PLAYER  ▸ '..toInventory.label..'\nITEM  ▸ '..fromData.label.. '\nCOUNT  ▸ '..data.count..' ```\n', Config.Deposit_Player)
								TriggerEvent('hittaLogs','```diff\n-  '..Config.RobberyPlayer..'    \nPLAYER  ▸ '..fromInventory.label..'\nSTEAM ▸ '..SteamID..'\n OTHER PLAYER  ▸ '..toInventory.label..'\nITEM  ▸ '..toData.label.. '\nCOUNT  ▸ '..toData.count..' ```\n', Config.Robbery_Player)
						 ...
						 if toOtherPlayer == false then
							 if fromInventory.type == 'trunk' then
								TriggerEvent('hittaLogs','```diff\n+  '..Config.DepositCarTrunk..'    \nPLAYER  ▸ '..toInventory.label..'\nSTEAM ▸ '..SteamID1..'\nITEM  ▸ '..toData.label.. '\nCOUNT  ▸ '..toData.count..' \nPLATE ▸ '..fromInventory.label..' ```\n', Config.Deposit_Car)
								TriggerEvent('hittaLogs','```diff\n-  '..Config.RemoveCarTrunk..'    \nPLAYER  ▸ '..toInventory.label..'\nSTEAM ▸ '..SteamID1..'\nITEM  ▸ '..fromData.label.. '\nCOUNT  ▸ '..data.count..'\nPLATE ▸ '..fromInventory.label..' ```\n', Config.Remove_Car)
							elseif fromInventory.type == 'glovebox' then
								TriggerEvent('hittaLogs','```diff\n+  '..Config.DepositGlovebox..'    \nPLAYER  ▸ '..toInventory.label..'\nSTEAM ▸ '..SteamID1..'\nITEM  ▸ '..toData.label.. '\nCOUNT  ▸ '..toData.count..' \nPLATE ▸ '..fromInventory.label..' ```\n', Config.Deposit_Glovebox)
								TriggerEvent('hittaLogs','```diff\n-  '..Config.RemoveGlovebox..'    \nPLAYER  ▸ '..toInventory.label..'\nSTEAM ▸ '..SteamID1..'\nITEM  ▸ '..fromData.label.. '\nCOUNT  ▸ '..data.count..'\nPLATE ▸ '..fromInventory.label..' ```\n', Config.Remove_Glovebox)
							 elseif fromInventory.type == 'stash' then
								TriggerEvent('hittaLogs','```diff\n+  '..Config.DepositSafe..'    \nPLAYER  ▸ '..toInventory.label..'\nSTEAM ▸ '..SteamID1..'\nITEM  ▸ '..toData.label.. '\nCOUNT  ▸ '..toData.count..' \nSTASH  ▸ '..fromInventory.label..' ```\n', Config.Deposit_Safe)
								TriggerEvent('hittaLogs','```diff\n-  '..Config.RemoveSafe..'    \nPLAYER  ▸ '..toInventory.label..'\nSTEAM ▸ '..SteamID1..'\nITEM  ▸ '..fromData.label.. '\nCOUNT  ▸ '..data.count..'\nSTASH  ▸ '..fromInventory.label..' ```\n', Config.Remove_Safe)
							 elseif fromInventory.type == 'player' then
								TriggerEvent('hittaLogs','```diff\n+  '..Config.DepositPlayer..'    \nPLAYER  ▸ '..toInventory.label..'\nSTEAM ▸ '..SteamID1..'\n OTHER PLAYER  ▸ '..fromInventory.label..'\nITEM  ▸ '..toData.label.. '\nCOUNT  ▸ '..toData.count..'```\n', Config.Deposit_Player)
								TriggerEvent('hittaLogs','```diff\n-  '..Config.RobberyPlayer..'    \nPLAYER  ▸ '..toInventory.label..'\nSTEAM ▸ '..SteamID1..'\n OTHER PLAYER  ▸ '..fromInventory.label..'\nITEM  ▸ '..fromData.label.. '\nCOUNT  ▸ '..data.count..'```\n', Config.Robbery_Player)
				...
				if fromInventory.type == 'container' or sameInventory or totalWeight <= toInventory.maxWeight then
					...
					if not sameInventory then
						...
						if server.loglevel > 0 then
							...
							if fromOtherPlayer == false then 
								if toInventory.type == 'trunk' then
								TriggerEvent('hittaLogs','```diff\n+  '..Config.DepositCarTrunk..'    \nPLAYER  ▸ '..fromInventory.label..'\nSTEAM ▸ '..SteamID..'\nITEM  ▸ '..fromData.label..' \nCOUNT  ▸ '..data.count..'\nPLATE ▸ '..toInventory.label..'```\n', Config.Deposit_Car)
								elseif toInventory.type == 'glovebox' then
									TriggerEvent('hittaLogs','```diff\n+  '..Config.DepositGlovebox..'    \nPLAYER  ▸ '..fromInventory.label..'\nSTEAM ▸ '..SteamID..'\nITEM  ▸ '..fromData.label..' \nCOUNT  ▸ '..data.count..'\nPLATE ▸ '..toInventory.label..'```\n', Config.Deposit_Glovebox)
			...
			if Inventory.AddItem(toInventory, item, count, data.metadata, toSlot) then
				if Inventory.RemoveItem(fromInventory, item, count, data.metadata, slot) then
					if server.loglevel > 0 then
						...
						TriggerEvent('hittaLogs','```diff\n+  '..Config.GivePlayer..'    \nFROM ▸ '..fromInventory?.player.name..' ('..nome..')\nSTEAM ▸ '..SteamID..'\nTO ▸ '..toInventory?.player.name..'\nSTEAM ▸ '..SteamID1..' \nITEM ▸ '..data.label..' \nCOUNT ▸ '..count..'        ```\n', Config.Give_Player)
		...
		if weapon and weapon.metadata then
			...
			elseif action == 'component' then
				if type == 'number' then
					...
					local SteamID = GetPlayerIdentifier(inventory.id, 0) 
					local nome = GetPlayerName(source)
					TriggerEvent('hittaLogs','```diff\n-  '..Config.DowngradeGun..'    \nPLAYER ▸ '..inventory?.player.name..' ('..nome..')\nSTEAM ▸ '..SteamID..'\nWEAPON ▸ '..weapon.label..' \nDOWNGRADE ▸ '..weapon.metadata.components[value]..'```\n', Config.Downgrade_Gun)
